...
RUN pip install -q --no-cache-dir -r requirements.txt && rm -f requirements.txt \
 && pip uninstall -yq pillow pillow-simd && pip install -q --no-cache-dir pillow-simd
