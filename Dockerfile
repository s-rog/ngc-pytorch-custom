...
ARG NB_USER="jovyan" NB_UID="1000" NB_GID="100" ULB=/usr/local/bin LANG=en_US.UTF-8
ENV CONDA_DIR=/opt/conda LANG=$LANG LANGUAGE=$LANG LC_ALL=$LANG \
    NB_USER=$NB_USER NB_UID=$NB_UID NB_GID=$NB_GID SHELL=/bin/bash
...
ENV JUPYTER_ENABLE_LAB=1 SHELL="/bin/zsh" TERM="xterm-256color" \
